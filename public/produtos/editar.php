...
<?php } ?>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="embalagem" name="embalagem" required>
<?php foreach($embalagens as $embalagem) { ?>
                            <option value="<?php echo $embalagem->getId() ?>"
                                <?php 
                                    if ($embalagem->getId() == $produto->getEmbalagem()->getId()) 
                                        echo 'selected'; 
                                ?>
                            >
                                <?php echo $embalagem->getNome() ?>
                            </option>
<?php } ?>
                        </select>                        
                    </div> 
